...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="flexcontainer">
        ...
        <div id="flexitem1">
            ...
            <div id="txtbox1">
                <asp:TextBox runat="server" ID="txtp" type="number" value="10000" ToolTip="Enter value between 10000 and 1000000" min="10000" max="1000000" size="8" placeholder="10000"  onchange="calculate()"></asp:TextBox>
            </div>
        </div>
        <%--Loan Years--%>
        <div id="flexitem2">
            <div id="lbl2">
                <asp:Label runat="server" ID="lbln" Text="Loan Tenure (Y) :" ></asp:Label>
            </div>
            <div id="txtbox2">
    ...
    <div id="content-container">
            ...
            <p><img id="formulaimg" src="images/emiformula.png"  /></p>
